### The definition of a Thyrd space.  There is only
### one space in Thyrd currently, so this object creates
### a persistent child called "theSpace".
###
### A space contains all the cells (by holding a reference to
### the root cell) and a TriadMapper that holds all Triads.
###
### Observable events:
...
# PJM	2007-07-24 Ops no longer live in Thyrdspace, they are
#					now distinct Poet objects
# PJM	2007-11-30 Editing wave moved here, now one global wave
#				   instead of one per CellEditor
# PJM	2008-06-11	waveMapper no longer persistent (since waves aren't)
# PJM	2008-10-30	import/export support begun
# PJM	2008-11-21	heart added
# PJM	2008-12-26	global options added
#

Object construct Space
Space mixin Observable

# The root cell of the space
Space slot root {}
Space type root Cell

# The object that manages the maps of cells to 
# triads
#
Space slot triadMapper {}
Space type triadMapper TriadMapper

# An array mapping  from a result cell to the wave that computes it
Space slot waveMapper {}
Space type waveMapper Map

# Stacks for undo/redo support
Space slot undo {}
Space slot redo {}

# Number of known waves and active waves
#
Space slot nWaves 0
Space type nWaves <integer> 
Space slot nActiveWaves 0
Space type nActiveWaves <integer> 
